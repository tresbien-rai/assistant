...
export const elements = {
    ...
    answerPreferences: document.getElementById('answerPreferences'),
    answerPreferencesCount: document.getElementById('answerPreferencesCount'),
    answerPreferencesStatus: document.getElementById('answerPreferencesStatus'),
